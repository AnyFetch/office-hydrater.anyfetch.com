...
module.exports = function(path, document, changes, cb) {
  ...
  async.waterfall([
    ...
    function convertToPdf(converter, cb) {
      ...
      office_child = shellExec('loffice ' + options.join(' ') + ' --convert-to pdf:"' + converter + '" --outdir /tmp ' + path, {maxBuffer: 20480 * 1024}, function(err, stdout, stderr) {
